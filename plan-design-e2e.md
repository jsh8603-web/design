...
| R11 | 1 | [seoul-citizen-marketing-masterclass/slide-29](/d/projects/slides-grab/slides/seoul-citizen-marketing-masterclass/slide-29.html) | SWOT 2x2 매트릭스 ✅검증완료·생성됨 |
| R11 | 2 | [tax-efficient-jv-guide/slide-16](/d/projects/slides-grab/slides/tax-efficient-jv-guide/slide-16.html) | 5단계 프로세스 ✅검증완료·생성됨 |
| R11 | 3 | [payroll-guide/slide-28](/d/projects/slides-grab/slides/payroll-guide/slide-28.html) | 인건비 α계수 9행표+사이드바 ✅검증완료·생성됨 |
| R11 | 4 | [samsung-investment-report/slide-11](/d/projects/slides-grab/slides/samsung-investment-report/slide-11.html) | 삼성vsSKH 7행비교표+insight ✅검증완료·생성됨 |
| R11 | 5 | [payroll-v2/slide-34](/d/projects/slides-grab/slides/payroll-v2/slide-34.html) | 1~6월 일정 9행표 ✅검증완료·생성됨 |
| R12 | 1 | [payroll-guide/slide-10](/d/projects/slides-grab/slides/payroll-guide/slide-10.html) | ✅Read검증완료 누적비율9행표+좌스택바+FP&A계수패널 (02목차 교체) |
| R12 | 2 | [payroll-v2/slide-17](/d/projects/slides-grab/slides/payroll-v2/slide-17.html) | ✅Read검증완료 일용vs상용 8행 인건비표(합계·계수행) |
| R12 | 3 | [samsung-investment-report/slide-12](/d/projects/slides-grab/slides/samsung-investment-report/slide-12.html) | ✅Read검증완료 듀얼패널 비교표(파운드리7행+모바일7행)+인사이트바 |
| R12 | 4 | [payroll-guide/slide-07](/d/projects/slides-grab/slides/payroll-guide/slide-07.html) | ✅Read검증완료 최저임금 월환산 3패널 복합(다크KPI+포함/미포함+수습감액) |
| R12 | 5 | [payroll-guide/slide-13](/d/projects/slides-grab/slides/payroll-guide/slide-13.html) | ✅Read검증완료 4대보험 5×5 비교표+다크 계산예시패널 (15디바이더 교체) |
| R13 | 1 | [payroll-guide/slide-22](/d/projects/slides-grab/slides/payroll-guide/slide-22.html) | 퇴직금 공식+산입 6행표+계산패널 ✅Read검증완료·생성완료 |
| R13 | 2 | [payroll-v2/slide-19](/d/projects/slides-grab/slides/payroll-v2/slide-19.html) | BEFORE/AFTER+영향 6행표+재무영향패널(밀집보강) ✅Read검증완료·생성완료 |
| R13 | 3 | [samsung-investment-report/slide-13](/d/projects/slides-grab/slides/samsung-investment-report/slide-13.html) | 3 hero KPI+소각 타임라인+배당 5불릿 ✅Read검증완료·생성완료 |
| R13 | 4 | [payroll-guide/slide-27](/d/projects/slides-grab/slides/payroll-guide/slide-27.html) | 인건비 예산공식+요율 8행표+계수표+FP&A 5배지 ✅Read검증완료·생성완료 |
| R13 | 5 | [payroll-guide/slide-23](/d/projects/slides-grab/slides/payroll-guide/slide-23.html) | DBO 3박스 공식+가정4행+회계4행표+인사이트3카드 ✅Read검증완료·생성완료 |
| R14 | 1 | [payroll-guide/slide-29](/d/projects/slides-grab/slides/payroll-guide/slide-29.html) | 건강·고용·산재 정산 3패널(각3step)+물류 계산예시 ✅Read검증완료·생성완료·클린 |
| R14 | 2 | [payroll-v2/slide-22](/d/projects/slides-grab/slides/payroll-v2/slide-22.html) | DB vs DC 비교 6행표+FP&A 선택가이드패널(밀집보강) ✅Read검증완료·생성완료·클린 |
| R14 | 3 | [samsung-investment-report/slide-15](/d/projects/slides-grab/slides/samsung-investment-report/slide-15.html) | 막대차트(OP추이)+부문별OP 5행표+Catalyst 3카드 ✅Read검증완료·생성완료·클린 |
| R14 | 4 | [payroll-guide/slide-33](/d/projects/slides-grab/slides/payroll-guide/slide-33.html) | 7~12월 월별 가로타임라인+월별상세표+다크 체크리스트 ✅Read검증완료·생성완료·클린 |
| R14 | 5 | [payroll-guide/slide-24](/d/projects/slides-grab/slides/payroll-guide/slide-24.html) | 계리보고서 4단계 프로세스 가로타임라인+하단2박스 ✅Read검증완료·생성완료·클린 |
| R15 | 1 | [payroll-guide/slide-36](/d/projects/slides-grab/slides/payroll-guide/slide-36.html) | 데이터밀집(grid2) ⏳착수Read검증 |
| R15 | 2 | [payroll-v2/slide-23](/d/projects/slides-grab/slides/payroll-v2/slide-23.html) | 데이터밀집(grid2) ⏳착수Read검증 |
| R15 | 3 | [samsung-investment-report/slide-08](/d/projects/slides-grab/slides/samsung-investment-report/slide-08.html) | 재무 데이터(grid2) ⏳착수Read검증 |
| R15 | 4 | [payroll-guide/slide-05](/d/projects/slides-grab/slides/payroll-guide/slide-05.html) | 데이터밀집(grid2) ⏳착수Read검증 |
| R15 | 5 | [payroll-v2/slide-35](/d/projects/slides-grab/slides/payroll-v2/slide-35.html) | 데이터밀집(grid2) ⏳착수Read검증 |

> **★R11~R15 신규 25장 선발 (2026-06-16)**: 초기 50장(R1~R10) 전량 소진 → 미사용 복잡 슬라이드 grep(`grid-template`/`display:grid` ≥2 AND `<img|<svg` ≤1) 데이터밀집 후보풀에서 신규 25장. R11 5장=Read 복잡도 검증완료+생성완료(커밋 96b5858). R12~R15 20장=grep 잠정선정 → **각 라운드 착수 시 Read 복잡도 재확인 의무(목차/단순/일러스트면 후보풀서 교체)**. ★grep 스코어 高 ≠ 복잡(tax-jv/02·payroll-v2/30 목차/단순 사례 — 반드시 Read). **후보풀 잔여(교체용)**: payroll-guide/v2 미사용 다수·tax-jv/03/09/10/11/12/15/17/18(목차/요약 혼재 주의)·seoul-marketing(차트/단순 혼재)·iran-crisis/mesozoic/noahs-ark(일러스트 혼재). 미사용 데이터밀집은 payroll/samsung 집중 → 유형(표/매트릭스/프로세스/일정) 다양화로 도메인 편중 보완.
