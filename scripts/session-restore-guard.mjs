...
try { appendFileSync(_EARLY_LOG, `${new Date().toISOString()} [session-restore-guard] START cwd=${process.cwd()} pid=${process.pid}\n`); } catch(e) {}
